...
export class ClassService {
  ...
  async getClassesByStudentYearAndMajor(year: number, majorId: number ): Promise<Class[]>{

    return this.http.get(this.hostname + this.endpoint + '/year/' + year + '/major/' + majorId, this.httpOptions)
    .toPromise() as Promise<Class[]>;
  }
